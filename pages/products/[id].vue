                ...
                <div class="card h-100 border-0">
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            ...
                            <span v-if="product.rating" class="text-muted ms-2">({{ product.rating['rate'] }}, {{
                        ...
                        <div class="d-flex flex-column align-items-center mb-3">
                            ...
                            <button :disabled="!shopStore.islogged" @click="shopStore.addProduct(product)"
                                class="w-100 btn btn-primary btn-lg flex-grow-1">
                                <i class="fas fa-shopping-cart me-2"></i>Add to Cart
                            </button>

                            <p v-show="!shopStore.islogged" class="alert alert-danger text-center w-100 my-2">- you have
                                to login first ! -</p>
